                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-100" v-for="nurse in nurses" :key="nurse.id">
                                ...
                                <td class="py-3 px-6 text-left">
                                    <div class="flex items-center gap-2">
                                        <svg @click="deleteNurse(nurse.id)" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
...
components: {
    editPatient
      ...
      this[buttonName] = !this[buttonName];
          ...
          deleteNurse(id){
            axios.delete('http://127.0.0.1:8000/api/nurse/delete/' + id)
            .then(response => {
